...
///
#ifndef __PE_CORE_FUNDAMENTALTYPES_H__
#define __PE_CORE_FUNDAMENTALTYPES_H__
...
#define PE_BIG_ENDIAN 4321
#define PE_LITTLE_ENDIAN 1234
#define PE_BYTE_ORDER PE_LITTLE_ENDIAN
#else
#include <sys/types.h>
#ifdef BYTE_ORDER
#define PE_BIG_ENDIAN BIG_ENDIAN
#define PE_LITTLE_ENDIAN LITTLE_ENDIAN
#define PE_BYTE_ORDER BYTE_ORDER
#else
#define PE_BIG_ENDIAN __BIG_ENDIAN
#define PE_LITTLE_ENDIAN __LITTLE_ENDIAN
#define PE_BYTE_ORDER __BYTE_ORDER
#endif
#endif
...
namespace pe {
  ...
  template <> struct AccumulatorType<pe::uint8>   { typedef pe::int32   type; };
  template <> struct AccumulatorType<pe::int8>    { typedef pe::int32   type; };
  template <> struct AccumulatorType<pe::uint16>  { typedef pe::int32   type; };
  template <> struct AccumulatorType<pe::int16>   { typedef pe::int32   type; };
  template <> struct AccumulatorType<pe::uint32>  { typedef pe::int64   type; };
  template <> struct AccumulatorType<pe::int32>   { typedef pe::int64   type; };
  template <> struct AccumulatorType<pe::uint64>  { typedef pe::int64   type; };
  template <> struct AccumulatorType<pe::int64>   { typedef pe::int64   type; };
  template <> struct AccumulatorType<pe::float32> { typedef pe::float64 type; };
  template <> struct AccumulatorType<pe::float64> { typedef pe::float64 type; };
  ...
  template <class T> struct FloatType { typedef pe::float32 type; };
  template <> struct FloatType<pe::uint32>  { typedef pe::float64 type; };
  template <> struct FloatType<pe::int32>   { typedef pe::float64 type; };
  template <> struct FloatType<pe::uint64>  { typedef pe::float64 type; };
  template <> struct FloatType<pe::int64>   { typedef pe::float64 type; };
  template <> struct FloatType<pe::float64> { typedef pe::float64 type; };
...
#endif // __PE_CORE_FUNDAMENTALTYPES_H__
