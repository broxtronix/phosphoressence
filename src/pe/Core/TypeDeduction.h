...
///
#ifndef __PE_CORE_TYPE_DEDUCTION_H__
#define __PE_CORE_TYPE_DEDUCTION_H__
...
#define __PE_STANDARD_ARITHMETIC_CONVERSIONS(Helper)                    \
  ...
  __PE_STANDARD_ARITHMETIC_CONVERSIONS(TypeDeductionHelper)
