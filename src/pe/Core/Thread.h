...
///   a POD class with an initializer macro PE_RUNONCE_INIT.  It must
...
///   statically initialized to PE_RUNONCE_INIT.)

#ifndef __PE_CORE_THREAD_H__
#define __PE_CORE_THREAD_H__
...
#define PE_RUNONCE_INIT { BOOST_ONCE_INIT }
  ...
  // and statically initialize them to PE_RUNONCE_INIT.
  struct RunOnce {
