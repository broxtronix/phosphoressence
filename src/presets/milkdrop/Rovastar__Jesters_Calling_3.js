function Rovastar__Jesters_Calling_3() {
  with (Math) {
    fRating=3;
    gamma=1.994;
    decay=0.93;
    ...
    ib_b = ib_b + 2.3*sin(time*3.547)*ypos;
    ...
    wave_g = 1-ib_b;
    wave_b = 1-ib_b;
    // per_pixel_1=q1 = 0.4*((sqrt(2)*0.5)-rad);
    ...
    // per_pixel_8=zoomexp = if_milk(q3,0.6+0.1*q5+ 0.5*q4,zoomexp);
    // per_pixel_9=zoom = zoomexp-0.005*(rad);
    // per_pixel_10=dx = if_milk(q3,0,-0.0015*bass);
    Eff_test =1;
    Eff_size = 400;
  }
}
register_preset( Rovastar__Jesters_Calling_3);
