function Rovastar__Hyperspace_Hyper_Speed_Mix() {
  with (Math) {
    fRating=3;
    gamma=2;
    decay=0.973;
    ...
    mv_b = wave_b;
    mv_g = wave_g;
    q1 = 0.5*(pow(1+1.2*bass+0.4*bass_att+0.1*treb+0.1*treb_att+0.1*mid+0.1*mid_att,6)/fps);
    //q1 = 0.6*(bass+bass_att);
    mv_a = if_milk(above(bass-1.2,1),1,bass-1.2);
    // per_pixel_1=zoom = 1.01 + rad*0.15*q1;
  }
}
register_preset( Rovastar__Hyperspace_Hyper_Speed_Mix);
