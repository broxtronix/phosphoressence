function che__burning_hus_oil_mix() {
  with (Math) {
    fRating=3;
    gamma=1;
    decay=1;
    ...
    q2=leccl;
    q3=btccl;
    q4=sqr(sin(.0023*leccl));
    q5=6.28*sqr(sin(.0023*leccl));
    ...
    // per_pixel_3=zoom=if_milk(below(abs(rot),.0025),exp(rad-q4),zoom);
    // per_pixel_4=rot=if_milk(below(abs(rot),.002),ang-q5,rot);
  }
}
register_preset( che__burning_hus_oil_mix);
