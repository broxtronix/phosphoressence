function Geiss__Supernova_1() {
  with (Math) {
    ...
    my_rad = sqrt(my_x*my_x + my_y*my_y);
    my_mod = 16 - 14*below(my_rad,0.2);
    decay = decay - 0.01*equal(frame%my_mod,0);
...
register_preset( Geiss__Supernova_1);
