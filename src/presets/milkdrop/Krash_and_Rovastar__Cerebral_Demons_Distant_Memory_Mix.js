function Krash_and_Rovastar__Cerebral_Demons_Distant_Memory_Mix() {
  with (Math) {
    fRating=2;
    gamma=2.993998;
    decay=1;
    ...
    ib_b = 0.06*bass;
    ib_g = 0.25+ypos;
    ib_r = 0.2125*ib_r + 0.7154*ib_g + 0.0721*ib_b;
    ib_g = ib_r;
    ib_b = ib_r;
...
register_preset( Krash_and_Rovastar__Cerebral_Demons_Distant_Memory_Mix);
