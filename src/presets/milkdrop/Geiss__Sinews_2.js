function Geiss__Sinews_2() {
  with (Math) {
    ...
    ib_r = ib_r + 0.1*sin(time*0.5413);
    ib_g = ib_g + 0.1*sin(time*0.6459);
    ib_b = ib_b + 0.1*sin(time*0.4354);
    blah = 0.6/(ib_r+ib_g+ib_b);
    ib_r = ib_r*blah; ib_g = ib_g*blah; ib_b = ib_b*blah;
    // per_pixel_1=cx=0.5 + 0.4*cos(ang+time*0.397-rad);
    // per_pixel_2=cy=0.5 + 0.4*sin(ang+time*0.78+rad);
  }
}
register_preset( Geiss__Sinews_2);
