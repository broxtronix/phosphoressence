function Unchained_and_Rovastar__Luckless() {
  with (Math) {
    fRating=2;
    gamma=1;
    decay=1;
    ...
    wave_mode=q7;
    zoom=zoom+.1*sin(time*.8);
    // per_pixel_1=rot = rot + if_milk(below(sin(ang+sin(rad+.5*q4)*5), q6), -rot, 0.5*sin((rad+.5*q1)*4*q5));
    // per_pixel_2=zoom=zoom+rot*q3;
  }
}
register_preset( Unchained_and_Rovastar__Luckless);
