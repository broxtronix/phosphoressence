function Rovastar__Harlequins_Dynamic_Fractal_Dual_Spiral_Mix_() {
  with (Math) {
    fRating=4;
    gamma=1;
    decay=1;
    ...
    ob_b = 0.35 - 0.3*cos(time*1.816);
    warp =0;
    ib_size = 0.02;
    ib_r = ib_r + 0.5*sin(time*3.034);
    ib_g = ib_g + 0.5*sin(time*3.147);
    ib_b = ib_b - 0.5*sin(time*3.431);
    dx = dx -0.003*sin(time*0.23);
    dy = dy - 0.003*sin(time*0.2);
...
register_preset( Rovastar__Harlequins_Dynamic_Fractal_Dual_Spiral_Mix_);
