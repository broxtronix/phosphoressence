function Rovastar__Jesters_Calling_2() {
  with (Math) {
    fRating=3;
    gamma=2;
    decay=0.96;
    ...
    q6 = 3*xpos;
    q4 = 3*ypos;
    decay = decay + if_milk(Eff_test,0,0.04);
    wave_r = 1-ib_g;
    wave_g = 1-ib_b;
    wave_b = 1-ib_b;
    ...
    // per_pixel_4=q7 =if_milk(q3,0,10 + floor(1*(rad)));
    // per_pixel_5=q8 =if_milk(q3,0,10 + floor(1*(rad)));
    // per_pixel_6=cx =if_milk(q3,0.5,(0&(x*q7-q1))*(1/q7)+0.1*q1);
    // per_pixel_7=cy =if_milk(q3,0.5,(0&(y*q8-q2))*(1/q8)+0.1*q2);
    // per_pixel_8=rot = if_milk(q3,2*q6*rad,0.1*rad+ 0.1*bass+0.00*cx*cy);
    // per_pixel_9=zoom = if_milk(q3,0.3+0.1*q5+ 0.5*q4,zoom);
    Eff_test =1;
    Eff_size = 400;
  }
}
register_preset( Rovastar__Jesters_Calling_2);
