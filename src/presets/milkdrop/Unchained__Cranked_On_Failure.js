function Unchained__Cranked_On_Failure() {
  with (Math) {
    fRating=2;
    gamma=2;
    decay=0.98;
    ...
    // per_pixel_3=rot=if_milk(above(q4,0),rad*.2*q5,rot+.3*sin(radix*3.14*(q1+q2+q3)));
    // per_pixel_4=zoom=if_milk(above(q2,0),zoom-cos(radix*3.14*q2)*.1,if_milk(above(q3,0),1+q1*.05,1+.07*cos(radix*10*q1)));
  }
}
register_preset( Unchained__Cranked_On_Failure);
