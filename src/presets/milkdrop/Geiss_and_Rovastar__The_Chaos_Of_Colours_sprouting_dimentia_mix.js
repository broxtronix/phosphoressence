function Geiss_and_Rovastar__The_Chaos_Of_Colours_sprouting_dimentia_mix() {
  with (Math) {
    fRating=2;
    gamma=1.7;
    decay=0.94;
...
register_preset( Geiss_and_Rovastar__The_Chaos_Of_Colours_sprouting_dimentia_mix);
