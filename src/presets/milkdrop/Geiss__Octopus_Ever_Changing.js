function Geiss__Octopus_Ever_Changing() {
  with (Math) {
    fRating=2;
    gamma=2;
    decay=0.98;
    ...
    mv_b=1;
    mv_a=0;
    wave_r = wave_r + 0.000*( 0.60*sin(1.517*time) + 0.40*sin(1.580*time) );
    wave_g = wave_g + 0.300*( 0.60*sin(1.088*time) + 0.40*sin(1.076*time) );
...
register_preset( Geiss__Octopus_Ever_Changing);
