function Rovastar__Harlequins_Dynamic_Fractal_1() {
  with (Math) {
    fRating=3;
    gamma=1;
    decay=1;
    ...
    xdx = dx -0.008*sin(time*0.23);
    xdy = dy - 0.008*sin(time*0.2);
    ...
    // per_pixel_5=dx = if_milk(above(box,1),q4,dx);
    // per_pixel_6=dy= if_milk(above(box,1),q2,dy);
  }
}
register_preset( Rovastar__Harlequins_Dynamic_Fractal_1);
