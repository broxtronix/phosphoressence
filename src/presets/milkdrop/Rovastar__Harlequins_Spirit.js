function Rovastar__Harlequins_Spirit() {
  with (Math) {
    fRating=3;
    gamma=1;
    decay=1;
    ...
    // per_pixel_5=dx = if_milk(above(box,1),sin(0.542*time),dx);
    // per_pixel_6=dy= if_milk(above(box,1),sin(0.581*time),dy);
  }
}
register_preset( Rovastar__Harlequins_Spirit);
