function Geiss__Planet_2() {
  with (Math) {
    ...
    mv_b=1;
    mv_a=0;
    wave_r = wave_r + 0.050*( 0.60*sin(0.933*time) + 0.40*sin(1.045*time) );
    ...
    decay=decay-0.01*equal(frame%3,0);
    // per_pixel_1=zoom=zoom-0.02*acos(x*2-1);
  }
}
register_preset( Geiss__Planet_2);
