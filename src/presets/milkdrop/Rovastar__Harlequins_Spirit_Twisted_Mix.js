function Rovastar__Harlequins_Spirit_Twisted_Mix() {
  with (Math) {
    fRating=3;
    gamma=1;
    decay=1;
    ...
    // per_pixel_4=dx = if_milk(above(box,1),sin(0.542*time),dx);
    // per_pixel_5=dy= if_milk(above(box,1),sin(0.581*time),dy);
    // per_pixel_6=zoomexp = if_milk(above(box,1),3,1);
  }
}
register_preset( Rovastar__Harlequins_Spirit_Twisted_Mix);
