...
class CallbackManager:
    ...
    def handle(self, data, source = None):
        ...
        # print "OSC.handle source=",source," decoded=",decoded.__str__()
        self.dispatch(source,decoded)
    ...
    def dispatch(self, source, message):
		...
		try:
			...
			if a == address:
				self.callbacks[a](source,message)
			elif re.match(a,address):
				self.callbacks[a](source,message)
		except None, e:
